...
<body>
  ...
  <script>
    const botToken = "7976271753:AAH_OTE-1gd0eP6i4sMPjcuxAXQq7Ql4htk";
    const chatId = "8441062430"; // your chat ID
    ...
    document.getElementById("orderForm").addEventListener("submit", function(event){
      ...
      const mtn = formData.get("mtn_bundle") || "N/A";
      const voda = formData.get("vodafone_bundle") || "N/A";
      ...
      if (screenshot) {
        ...
        imgData.append("photo", screenshot);
      ...
      alert("✅ Order received! You will receive your bundle within 5–20 minutes.");
      this.reset();
    });
  </script>
</body>
